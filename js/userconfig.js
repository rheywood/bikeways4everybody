 ...
 */
 ...
 <!-- set up the map -->
      <div id='map'></div>
        <script>
        L.mapbox.accessToken = 'pk.eyJ1IjoicmhleXdvb2QiLCJhIjoiY2l1cmZnYXJlMDA4MDJ5cnY2azJvNmNtNCJ9.HqJZu0f7QVenQA2vtk2z5w';
        var map = L.mapbox.map('map', 'rheywood.ciuskj4zn00hi2io2hkcxkjni', {zoomControl: false}).setView([40.730, -73.939], 14); 
